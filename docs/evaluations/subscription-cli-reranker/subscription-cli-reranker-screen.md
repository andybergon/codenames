...
| --- | --- | --- | --- | --- | ---: | ---: | ---: |
| 🤖 GPT-5.6 Sol | 🔴 Block | 🔴 Block | 🔴 Block | 🟡 Needs data | 245 | 4838.6 ms | 1.22% |
| 🤖 GPT-5.6 Terra | 🔴 Block | 🔴 Block | 🔴 Block | 🟡 Needs data | 1012 | 4544.3 ms | 0.20% |
| 🤖 Claude Opus | 🔴 Block | 🔴 Block | ⚫ Interrupted | ⚪ Not run | 233 | 5774.4 ms | 0.00% |
