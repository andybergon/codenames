...
- Mean-centering improves every tested model on the human Codenames datasets; compare centered variants when evaluating a production swap. The checked report and runtime indexes both use the same 30,000-clue centering corpus.
