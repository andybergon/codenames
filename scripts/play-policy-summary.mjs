...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 🧪 Hybrid | ${percent(hybrid.multiClueRate)} | ${decimal(hybrid.firstHalfMeanClueNumber)} | ${decimal(hybrid.correctCardsPerTurn)} | ${decimal(hybrid.wrongTeamHitsPerGame)} | ${percent(hybrid.assassinRate)} | ${decimal(hybrid.meanTurnsPerGame)} |
| 📍 Current | ${percent(current.multiClueRate)} | ${decimal(current.firstHalfMeanClueNumber)} | ${decimal(current.correctCardsPerTurn)} | ${decimal(current.wrongTeamHitsPerGame)} | ${percent(current.assassinRate)} | ${decimal(current.meanTurnsPerGame)} |
