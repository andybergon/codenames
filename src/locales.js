...
const COPY = Object.freeze({
  [LANGUAGE.ENGLISH]: Object.freeze({
    ...
    clueRepeatPrevious: "Block the team's previous clue",
    clueRepeatAllow: "Allow repeats",
    neverRepeatClues: "never repeat team clues",
    blockPreviousClue: "block previous team clue",
    ...
    operativeScoreExplanation: ({ model }) =>
      `${model} association score. Higher scores mean a closer operative match.`,
    target: "Target",
    guessOrdinal: ({ index }) => `Guess ${index}`,
    operativeCosineSimilarity: "Operative association score",
  ...
  [LANGUAGE.ITALIAN]: Object.freeze({
    ...
    clueRepeatPrevious: "Blocca l'ultimo indizio della squadra",
    clueRepeatAllow: "Consenti ripetizioni",
    neverRepeatClues: "mai ripetere gli indizi della squadra",
    blockPreviousClue: "blocca l'ultimo indizio della squadra",
    ...
    operativeScoreExplanation: ({ model }) =>
      `Punteggio di associazione di ${model}. Un valore più alto indica una maggiore affinità per l'agente.`,
    target: "Obiettivo",
    guessOrdinal: ({ index }) => `Tentativo ${index}`,
    operativeCosineSimilarity: "Punteggio di associazione dell'agente",
